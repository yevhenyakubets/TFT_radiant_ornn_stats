...
function RadiantPage() {
  ...
  // ADDED: State to toggle visibility of niche/invalid champions
  const [showInvalid, setShowInvalid] = useState(false);
  const [showLowSample, setShowLowSample] = useState(false); // Hidden by default
